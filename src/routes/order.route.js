...
const { cancelOrder, getOrderByUserId, getOrderByVendorId, getAllOrders, getOrderById, updateOrderByAdmin } = require('../controllers/order.controller.js')
...
// Update by role
router.patch('/:orderId/status', authAdminMiddleware, updateOrderByAdmin)
